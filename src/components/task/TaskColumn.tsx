...
export function TaskColumn({
  ...
  return (
    <section className="min-h-80 min-w-[18rem] rounded-lg border border-slate-200 bg-slate-100/70 p-4 dark:border-slate-800 dark:bg-slate-900/70 sm:min-w-[20rem] lg:min-w-0">
